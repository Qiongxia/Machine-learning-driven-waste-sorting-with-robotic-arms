...
def capture_multi_angle_photos():
    ...
    try:
        ...
        poses = [
            {
                "name": "pose_1",
                "pose": PoseObject(0.231, -0.005, 0.236, 3.075, 1.308, 3.138),
                "description": "Top view"
            },
            {
                "name": "pose_2", 
                "pose": PoseObject(0.246, -0.051, 0.249, 2.213, 1.139, 1.892),
                "description": "Left side view"
            },
            {
                "name": "pose_3",
                "pose": PoseObject(0.246, 0.042, 0.250, -2.333, 1.112, -1.841),
                "description": "Right side view"
            },
            {
                "name": "pose_4",
                "pose": PoseObject(0.231, -0.005, 0.204, 3.075, 1.308, 3.138),
