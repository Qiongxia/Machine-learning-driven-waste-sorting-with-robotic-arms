...
SAVE_PATH = "1203 fixedcalibration_matrix1.npy" 

 

def pixel_to_robot(u, v, transform_matrix, z=0.033333): 
...
for i in range(4): 
    ...
    input(f"\n press Enter after moving to point {i+1} ...") 
...
camera_pose = [0.006, 0.162, 0.253, 3.034, 1.327, -1.712]
...
while True: 
    ...
    if ans == 'n': 
        ...
        u = float(input("input pixel u coordinate: ")) 

        v = float(input("input pixel v coordinate: ")) 
